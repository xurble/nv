...
1. **Completed August 2026:** Restored the Phase 1 safety net to green. Clean composed runs now report 842 Debug warnings and 843 Release warnings against the ceiling of 875, retain the corrected `master` push trigger, and reach the app smoke test, both XCTest targets, and every characterization executable.
