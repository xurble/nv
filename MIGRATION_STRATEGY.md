...
**Progress as of August 2026 — next migration phase:** No SQLite FTS catalog, summary/body split, Core Spotlight, `IndexedEntity`, `NoteEntity`, protected-index, UUID-opening, background indexer, or Spotlight privacy implementation exists yet.
...
6. **Next migration goal — Phase 5:** add the account-scoped SQLite summary/availability/FTS catalog, split summary and body loading, route in-app search through the index, implement bounded hydration, and ship the UUID-backed protected Core Spotlight projection, alias-aware deep links, privacy controls, incremental updates, rebuild, and measured 1,000-/10,000-note Mac/iPhone/iPad coverage.
